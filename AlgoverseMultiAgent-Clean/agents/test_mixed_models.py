...
async def test_model_configuration():
    ...
    try:
        ...
        orchestrator = await create_optimized_marag_pipeline(
            ...
            planning_model="gemini-2.5-pro-preview-03-25",    # LLM
            step_definition_model="gemini-2.5-pro-preview-03-25",  # LLM
            qa_model="gemini-2.5-pro-preview-03-25"           # LLM
        )
...
async def test_agent_initialization():
    ...
    try:
        ...
        llm_models = ["gemini-2.5-pro-preview-03-25"]
