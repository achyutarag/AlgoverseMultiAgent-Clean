"""
Extract CSV from existing clean debug report JSON file.

Usage:
    python extract_csv_from_report.py results/clean_debug_report_20260119_124850.json
"""
...
def extract_csv_from_report(json_file: str):
    """Extract CSV from clean debug report JSON."""
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print("Example: python extract_csv_from_report.py results/clean_debug_report_20260119_124850.json")
        sys.exit(1)
